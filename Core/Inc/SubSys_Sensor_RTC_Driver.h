...
#ifndef SAT_PAYLOAD_SUBSYS_DRIVERS_SENSOR_RTC_H_
#define SAT_PAYLOAD_SUBSYS_DRIVERS_SENSOR_RTC_H_
...
/*----------------------------------------------------------------------------*/
#define SAT_PAYLOAD_RTC_CONFIG_PERMISSION_HEADERGUARD	/*Eneable or disable Satellite carrier's variable*/
...
void DS1307_GetAllDatas(void);

uint8_t DS1307_DecodeBCD(uint8_t bin);
uint8_t DS1307_EncodeBCD(uint8_t dec);

#endif /* INC_SUBSYS_SENSOR_RTC_DRIVER_H_ */
